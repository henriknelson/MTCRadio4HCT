...
public class IRTable {
    ...
    public static final int IR_CAR_360 = 513;
    public static final int IR_CAR_INFO = 512;
    public static final int IR_CAR_RIGHTVIEW_START = 514;
    public static final int IR_CAR_RIGHTVIEW_STOP = 515;
    ...
    public static final int IR_GOOGLE_VOICE = 384;
