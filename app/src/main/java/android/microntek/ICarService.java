...
public interface ICarService extends IInterface {
    ...
    public static abstract class Stub extends Binder implements ICarService {
        ...
        static final int TRANSACTION_dispatchMessage = 20;
        ...
        static final int TRANSACTION_getVideoEnable = 26;
        ...
        static final int TRANSACTION_setEqIdx = 21;
        static final int TRANSACTION_setLud = 23;
        static final int TRANSACTION_setParameters = 17;
        static final int TRANSACTION_setVideoOverSpeed = 25;
        ...
        private static class Proxy implements ICarService {
            ...
            public void dispatchMessage(String type, Bundle bundle) throws RemoteException {
                Parcel _data = Parcel.obtain();
                Parcel _reply = Parcel.obtain();
                try {
                    _data.writeInterfaceToken(Stub.DESCRIPTOR);
                    ...
                    this.mRemote.transact(Stub.TRANSACTION_dispatchMessage, _data, _reply, 0);
                    _reply.readException();
                } finally {
                    _reply.recycle();
                    _data.recycle();
            ...
            public void setEqIdx(int idx) throws RemoteException {
                ...
                try {
                    _data.writeInterfaceToken(Stub.DESCRIPTOR);
                    _data.writeInt(idx);
                    this.mRemote.transact(Stub.TRANSACTION_setEqIdx, _data, _reply, 0);
                    _reply.readException();
                } finally {
                    _reply.recycle();
                    _data.recycle();
            ...
            public int getEqIdx() throws RemoteException {
                ...
                try {
                    _data.writeInterfaceToken(Stub.DESCRIPTOR);
                    this.mRemote.transact(Stub.TRANSACTION_getEqIdx, _data, _reply, 0);
                    _reply.readException();
                    int _result = _reply.readInt();
                    return _result;
                } finally {
            ...
            public void setLud(boolean on) throws RemoteException {
                ...
                try {
                    ...
                    _data.writeInt(i);
                    this.mRemote.transact(Stub.TRANSACTION_setLud, _data, _reply, 0);
                    _reply.readException();
                } finally {
                    _reply.recycle();
                    _data.recycle();
            ...
            public int getLud() throws RemoteException {
                ...
                try {
                    _data.writeInterfaceToken(Stub.DESCRIPTOR);
                    this.mRemote.transact(Stub.TRANSACTION_getLud, _data, _reply, 0);
                    _reply.readException();
                    int _result = _reply.readInt();
                    return _result;
                } finally {
            ...
            public void setVideoOverSpeed(boolean overSpeed) throws RemoteException {
                int i = 0;
                Parcel _data = Parcel.obtain();
                Parcel _reply = Parcel.obtain();
                try {
                    ...
                    _data.writeInt(i);
                    this.mRemote.transact(Stub.TRANSACTION_setVideoOverSpeed, _data, _reply, 0);
                    _reply.readException();
                } finally {
                    _reply.recycle();
                    _data.recycle();
            ...
            public boolean getVideoEnable() throws RemoteException {
                Parcel _data = Parcel.obtain();
                Parcel _reply = Parcel.obtain();
                boolean _result = false;
                try {
                    _data.writeInterfaceToken(Stub.DESCRIPTOR);
                    this.mRemote.transact(Stub.TRANSACTION_getVideoEnable, _data, _reply, 0);
                    _reply.readException();
        ...
        public boolean onTransact(int code, Parcel data, Parcel reply, int flags) throws RemoteException {
            ...
            switch (code) {
                ...
                case TRANSACTION_getBooleanState /*8*/:
                    data.enforceInterface(DESCRIPTOR);
                    _result = getBooleanState(data.readString());
                    reply.writeNoException();
                ...
                case TRANSACTION_getIntState /*10*/:
                    data.enforceInterface(DESCRIPTOR);
                    _result2 = getIntState(data.readString());
                    reply.writeNoException();
                    reply.writeInt(_result2);
                    return true;
                case TRANSACTION_getStringState /*11*/:
                    data.enforceInterface(DESCRIPTOR);
                    _result3 = getStringState(data.readString());
                    reply.writeNoException();
                ...
                case TRANSACTION_setParameters /*17*/:
                    data.enforceInterface(DESCRIPTOR);
                    _result2 = setParameters(data.readString());
                    reply.writeNoException();
                    reply.writeInt(_result2);
                    return true;
                case TRANSACTION_getParameters /*18*/:
                    data.enforceInterface(DESCRIPTOR);
                    _result3 = getParameters(data.readString());
                    reply.writeNoException();
                    reply.writeString(_result3);
                    return true;
                case TRANSACTION_putDataChanage /*19*/:
                    ...
                    reply.writeNoException();
                    return true;
                case TRANSACTION_dispatchMessage:
                    Bundle _arg1;
                    data.enforceInterface(DESCRIPTOR);
                    ...
                    dispatchMessage(_arg0, _arg1);
                    reply.writeNoException();
                    return true;
                case TRANSACTION_setEqIdx:
                    data.enforceInterface(DESCRIPTOR);
                    setEqIdx(data.readInt());
                    reply.writeNoException();
                    return true;
                case TRANSACTION_getEqIdx:
                    data.enforceInterface(DESCRIPTOR);
                    _result2 = getEqIdx();
                    reply.writeNoException();
                    reply.writeInt(_result2);
                    return true;
                case TRANSACTION_setLud:
                    data.enforceInterface(DESCRIPTOR);
                    setLud(data.readInt() != 0);
                    reply.writeNoException();
                    return true;
                case TRANSACTION_getLud:
                    data.enforceInterface(DESCRIPTOR);
                    _result2 = getLud();
                    reply.writeNoException();
                    reply.writeInt(_result2);
                    return true;
                case TRANSACTION_setVideoOverSpeed:
                    data.enforceInterface(DESCRIPTOR);
                    setVideoOverSpeed(data.readInt() != 0);
                    reply.writeNoException();
                    return true;
                case TRANSACTION_getVideoEnable:
                    data.enforceInterface(DESCRIPTOR);
                    _result = getVideoEnable();
                    reply.writeNoException();
                    reply.writeInt(_result ? 1 : 0);
                    return true;
    ...
    void dispatchMessage(String str, Bundle bundle) throws RemoteException;
    ...
    boolean getVideoEnable() throws RemoteException;
    ...
    void setVideoOverSpeed(boolean z) throws RemoteException;
